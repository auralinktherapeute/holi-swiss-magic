...
const T = {
  fr: { home: "Accueil", therapists: "Thérapeutes", loading: "Chargement…", notFound: "Combinaison introuvable.", back: "Retour à l'annuaire", at: "à", inSpec: "en", therapist: "thérapeute", therapistPlural: "thérapeutes", none: "Aucun thérapeute référencé en", forNow: "pour le moment.", seeAll: (n: string) => `Voir tous les praticiens de ${n} en Suisse →`, titleAt: "à", titleSuffix: "— Holiswiss", desc: (l: string, c: string) => `Trouvez un praticien de ${l} à ${c} : profils validés par Holiswiss, tarifs, prise de rendez-vous en ligne.` },
  de: { home: "Startseite", therapists: "Therapeuten", loading: "Wird geladen…", notFound: "Kombination nicht gefunden.", back: "Zurück zum Verzeichnis", at: "in", inSpec: "in", therapist: "Therapeut", therapistPlural: "Therapeuten", none: "Noch keine Therapeuten für", forNow: "eingetragen.", seeAll: (n: string) => `Alle ${n}-Fachpersonen in der Schweiz ansehen →`, titleAt: "in", titleSuffix: "— Holiswiss", desc: (l: string, c: string) => `Finden Sie eine Fachperson für ${l} in ${c}: von Holiswiss geprüfte Profile, Preise, Online-Buchung.` },
  it: { home: "Home", therapists: "Terapeuti", loading: "Caricamento…", notFound: "Combinazione non trovata.", back: "Torna alla directory", at: "a", inSpec: "in", therapist: "terapeuta", therapistPlural: "terapeuti", none: "Nessun terapeuta registrato in", forNow: "per il momento.", seeAll: (n: string) => `Vedi tutti i professionisti di ${n} in Svizzera →`, titleAt: "a", titleSuffix: "— Holiswiss", desc: (l: string, c: string) => `Trova un professionista di ${l} a ${c}: profili convalidati da Holiswiss, tariffe, prenotazione online.` },
  en: { home: "Home", therapists: "Therapists", loading: "Loading…", notFound: "Combination not found.", back: "Back to directory", at: "in", inSpec: "in", therapist: "therapist", therapistPlural: "therapists", none: "No therapists listed in", forNow: "yet.", seeAll: (n: string) => `See all ${n} practitioners in Switzerland →`, titleAt: "in", titleSuffix: "— Holiswiss", desc: (l: string, c: string) => `Find a ${l} practitioner in ${c}: profiles validated by Holiswiss, prices, online booking.` },
} as const;
