...
const T = {
  fr: { home: "Accueil", therapists: "Thérapeutes", inSwitzerland: "en Suisse", loading: "Chargement…", notFound: "Spécialité introuvable.", back: "Retour à l'annuaire", therapist: "thérapeute", therapistPlural: "thérapeutes", inSpec: "en", none: "Aucun thérapeute référencé en", forNow: "pour le moment.", nearby: "Spécialités proches", titleSuffix: "en Suisse — Annuaire des thérapeutes | Holiswiss", desc: (l: string) => `Trouvez un praticien de ${l} en Suisse : profils détaillés, tarifs, avis. Prenez rendez-vous en quelques clics.` },
  de: { home: "Startseite", therapists: "Therapeuten", inSwitzerland: "in der Schweiz", loading: "Wird geladen…", notFound: "Spezialität nicht gefunden.", back: "Zurück zum Verzeichnis", therapist: "Therapeut", therapistPlural: "Therapeuten", inSpec: "in", none: "Noch keine Therapeuten für", forNow: "eingetragen.", nearby: "Ähnliche Spezialitäten", titleSuffix: "in der Schweiz — Therapeutenverzeichnis | Holiswiss", desc: (l: string) => `Finden Sie eine Fachperson für ${l} in der Schweiz: detaillierte Profile, Preise, Bewertungen. In wenigen Klicks buchen.` },
  it: { home: "Home", therapists: "Terapeuti", inSwitzerland: "in Svizzera", loading: "Caricamento…", notFound: "Specialità non trovata.", back: "Torna alla directory", therapist: "terapeuta", therapistPlural: "terapeuti", inSpec: "in", none: "Nessun terapeuta registrato in", forNow: "per il momento.", nearby: "Specialità simili", titleSuffix: "in Svizzera — Elenco dei terapeuti | Holiswiss", desc: (l: string) => `Trova un professionista di ${l} in Svizzera: profili dettagliati, tariffe, recensioni. Prenota in pochi clic.` },
  en: { home: "Home", therapists: "Therapists", inSwitzerland: "in Switzerland", loading: "Loading…", notFound: "Specialty not found.", back: "Back to directory", therapist: "therapist", therapistPlural: "therapists", inSpec: "in", none: "No therapists listed in", forNow: "yet.", nearby: "Related specialties", titleSuffix: "in Switzerland — Therapist directory | Holiswiss", desc: (l: string) => `Find a ${l} practitioner in Switzerland: detailed profiles, prices, reviews. Book in a few clicks.` },
} as const;
