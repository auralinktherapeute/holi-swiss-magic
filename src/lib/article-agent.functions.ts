...
// externe (rapport JSON/HTML) apparaisse dans /admin/articles en
...
function resolveCategoryImport(input: Record<string, unknown>, title: string): string {
  ...
  const pairs: Array<[string, string[]]> = [
    ["geobiologie", ["geobiologie", "habitat sain", "harmonisation lieu"]],
...
function normalizeImportArticle(input: Record<string, unknown>) {
